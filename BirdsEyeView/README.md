...
- [Carla based BEV Semantic Segmentation dataset](https://www.kaggle.com/datasets/sakshaymahna/semantic-segmentation-bev)
- [nuScenes dataset](https://www.nuscenes.org/nuscenes)
- [KITTI BEV benchmark](https://www.cvlibs.net/datasets/kitti/eval_object.php?obj_benchmark=bev)

## Blogs
- [3D OD methods comparison](https://medium.com/ike-blog/perception-for-automated-trucking-c8a8c12e1015)
- [Comparing BEV vs RV approach](https://towardsdatascience.com/the-state-of-3d-object-detection-f65a385f67a8)

### Traditional Computer Vision
- [Homography Transform — Image Processing](https://mattmaulion.medium.com/homography-transform-image-processing-eddbcb8e4ff7#:~:text=Homography%2C%20also%20referred%20to%20as,in%20a%20homogenous%20coordinates%20space.)
